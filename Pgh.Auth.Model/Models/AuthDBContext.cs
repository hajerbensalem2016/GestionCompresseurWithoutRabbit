    ...
    public class AuthDbContext : DbContext
    {
       ...
       public DbSet<Filiale> Filiale { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //192.168.60.94
                //optionsBuilder.UseSqlServer(@"Data Source=tcp:172.21.66.129,1433;Database=Pgh.AuthService2;User ID=hajour;Password=340$Uuxwp7Mcxo7Khy; MultipleActiveResultSets=True");
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Database=Pgh.AuthService10;Trusted_Connection=True;MultipleActiveResultSets=true");
